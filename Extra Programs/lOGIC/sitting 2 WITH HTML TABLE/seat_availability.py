...
def seat_availability():
    if request.method == 'GET':
        try:
            ...
            # Query to fetch flights from the airline_sitting table (or relevant flight table)
            cursor.execute("SELECT flight_Number, flight_Name, origin, dest, jd FROM airline_sitting GROUP BY flight_Number, flight_Name, jd")
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for flight_class, total_seats in seat_layout.items():
                booked_seats_query = """
